...
class ChemDemo(object):
    def __init__(self, model, confidence_threshold=0.7, device=torch.device("cpu")):
        self.model = model
        self.model.eval()
        self.device = device
        ...
        self.palette = [[255,0,0], [0,255,0], [0,0,255], [255,255,0], [0,255,255], [255,0,255], [255,255,255]]
