...
ImageDir="../../LabPicData/LabPics2.1/COCO_raw/train2017" # image folder (coco training) train set
AnnotationDir="../../LabPicData/LabPics2.1/COCO_raw/panoptic_train2017" # annotation maps folder from coco panoptic train set
DataFile="../../LabPicData/LabPics2.1/COCO_raw/panoptic_train2017.json" # Json Data file coco panoptic train set


OutDir="../../LabPicData/LabPics2.1//COCO" # Output Dir
###############################Vessel cats in COCO###################################################################################################################
