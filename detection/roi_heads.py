...
def subclass_loss(subclass_logits, sub_labels):
    ...
    loss = F.binary_cross_entropy_with_logits(subclass_logits, sub_labels)
...
class RoIHeads(nn.Module):
    ...
    def select_training_samples(self,
        ...
        for img_id in range(num_images):
            ...
            try:
                ...
                gt_sub = torch.zeros((512,25), dtype=torch.long, device=device)
                matched_gt_sub.append(gt_sub[matched_idxs[img_id]])
    ...
    def postprocess_detections(self,
        ...
        for boxes, scores, sub_scores,image_shape in zip(pred_boxes_list, pred_scores_list,pred_sub_list, image_shapes):
            ...
            sub_labels = sub_labels.reshape(-1, num_sub_cls)
